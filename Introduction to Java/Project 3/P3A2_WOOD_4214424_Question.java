...
This program will create a class that can create question objects. It will include 6 fields. 1 question, 4 responses, and 1 correct answer.
All of the fields will be able to be accessed and set through accesor and mutator methods. It will also contain a constructor method that will
accept 6 arguments to be set to the 6 individual fields.*/

public class P3A2_WOOD_4214424_Question
{
	...
	public P3A2_WOOD_4214424_Question(String Q, String A1, String A2, String A3, String A4, String CA)
	{
		this.Q = Q;
		this.A1 = A1;
		this.A2 = A2;
